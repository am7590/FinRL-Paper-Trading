...
from tutorials.FinRL_PortfolioAllocation_Explainable_DRL.scripts.shared_logger import log_and_print

# Log the setup information
log_and_print("Starting A2C paper trading...")
...
log_and_print("A2C model loaded successfully!")
...
log_and_print("Trading session completed successfully!")